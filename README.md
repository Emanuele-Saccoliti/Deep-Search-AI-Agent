...
This project implements an AI research agent agent using the LangChain framework, OpenAI GPT-4o, and Pydantic for structured output parsing. The agent is designed to interactively handle user queries by leveraging external tools such as web search, Wikipedia access, and optional saving mechanisms.
